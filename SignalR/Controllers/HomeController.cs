...
namespace SignalR.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, IHubContext<OrderHub> _orderHub, IHubContext<DeathlyHallowsHub> _deathlyHub, ApplicationDbContext _context)
        {
            _logger = logger;
            this._deathlyHub = _deathlyHub;
            this._context = _context;
            this._orderHub = _orderHub;
        }
        ...
        public async Task<IActionResult> DeathlyHallows(string type)
        {
            ...
            await _deathlyHub.Clients.All.SendAsync("updateDeathlyHallowsCount", SD.DealthyHallowRace[SD.Cloak], SD.DealthyHallowRace[SD.Stone], SD.DealthyHallowRace[SD.Wand]);
            return Accepted();
        }
        ...
        public IActionResult HarryPortalHouse()
        {
            return View();
        }
